const sheetURL = "https://docs.google.com/spreadsheets/d/1Ln8ibmnM2o06Hp1NZ2ug-r4Mw-6MFOSRJRIJYG9tiho/export?format=csv";
...
function submitQuiz(btn){
    ...
    fetch("https://docs.google.com/forms/d/e/1FAIpQLSfoCAwUSkgimSV4eZFBzkrRDWsJCsLi78AAX7ywxa2_C-iwtA/formResponse",{
        method:"POST",
        mode:"no-cors",
        body:fd
    }).then(()=>{
